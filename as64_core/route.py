...
class Route(object):
    def __init__(self, file_path, title, splits, initial_star=0, version="JP", category=""):
...
class Split(object):
    def __init__(self, title: str = "", star_count: int = 0, on_fadeout: int = 0, on_fadein: int = 0, split_type: str = SPLIT_NORMAL, icon_path: str = None):
